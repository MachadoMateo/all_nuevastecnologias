...
nombres = ["Alejandro", "Valeria", "Diego", "Andrea", "Gabriel", "Isabel", "Sergio", "Natalia", "Mateo", "Paula"]
apellidos = ["Ramírez", "Castillo", "Jiménez", "Morales", "Medina", "Vargas", "Herrera", "Silva", "Castro", "Rojas"]
